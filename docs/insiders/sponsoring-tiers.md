...
我们提供一系列针对我们不同需求量身定制的赞助级别
社区。无论你是个人用户，还是扎根于学术界，或者在
一个在商业上使用我们软件的组织，有一个赞助层
这符合你的需要。

## 选择一个层级

选择合适的赞助级别取决于您的需求以及您打算如何
使用MkDocs内部人员的材料。我们的级别分为[非商业]
和[商业]用途：

  - __非商业层__: 适用于个人、开源项目、，
    学术用途
  - __商业层__: 专为任何规模的组织和企业设计

每个[每月赞助级别]都根据您的需求提供一系列福利。
好处包括访问我们的私人MkDocs Insiders材料库，
优先处理错误报告等，具体取决于
您打算使用它构建的项目[^1]和所需的合作者。
请记住，您始终可以[升级或降级]您的
任何时候的赞助级别。

  [^1]:
    项目被定义为具有“mkdocs.yml”配置文件的文件夹
    它是用MkDocs Insider的Material构建的。这是唯一的限制
    遵循文档页数或项目大小
    随你。
...
每月赞助级别为您提供访问我们私人材料的权限
MkDocs Insiders存储库。您的财务贡献支持了正在进行的
开发Insiders和社区版。

### 非商业用途

非商业用途本质上是指“个人使用”。这包括个人
将Insiders版本用于个人或纯非商业开源
项目。我们为非商业用途提供两种不同的等级。

---

#### 个人

你喜欢MkDocs的Material，并将其用于你的开源项目或个人
博客。你在Insiders中读到了所有很棒的功能，这是第一个
独家发布给赞助商，不想错过。
...
您将Material for MkDocs用于多个开源项目或个人
网站，只是喜欢你可以构建漂亮的文档，而无需
担心不断崩溃的JavaScript生态系统——现在
[@squidfunk]的工作。
...
商业用途是指将我们的软件用于商业或营利目的
目的。这包括公司或其他组织的任何使用，无论是
或者它们是否直接从软件中产生收入。我们提供不同的
商业用途的定价层次，每个层次都根据不同需求量身定制
企业。重要的是要注意，您内部对软件的使用
组织也被认为是商业用途，就像所有商业软件一样。

---

#### 组织 :star:

您的组织使用MkDocs材料进行文档或内部
知识库，并希望确保其维护良好且使用安全
在未来的岁月里。您同意每月125美元（不到1小时）
熟练的开发人员）是对解决方案的明智投资，可以解决大量问题
你不想与自己抗争的问题。
...
您的组织运行着许多内部和面向公众的网站，这些网站是使用
MkDocs的材料，帮助您高效地共享和管理知识。
您已经评估了几种商业替代品，这些替代品的成本将增加3-4x，
其中一些具有较小的功能集。你同意每月250美元（低于
2小时的熟练开发人员）对于您获得的价值来说是一笔非常划算的交易
摆脱它。
...
贵组织的日常运营在很大程度上依赖于材料
MkDocs，你需要确保快速修复错误，以保持你的
客户满意。你将你的工作视为更大生态系统的一部分，意识到
回馈社会对于让你为之奋斗的一切保持活力至关重要。
...
对于那些希望一次性捐款而不进行持续订阅的人
在无法访问Insiders独家功能的情况下，我们提供
遵循一次性赞助级别。

---

### 只是一个提示！ :money_with_wings:

你提出了一个问题或需要一些帮助，我们已经帮助了你
迅速地。你不想要额外的好处，只想要好的业力和温暖的奉献感
回来的东西。
...
与[@squidfunk]进行了1小时的视频通话，他是该网站的创建者和核心维护者
项目。他很乐意与你分享他的经历，并帮助你
任何与他的工作有关的事情。
...
我们邀请您通过GitHub赞助商贡献自定义赞助金额，
使您能够根据自己的喜好支持MkDocs的Material。
请注意，个人需要每月至少认捐15美元
访问内部人员，而鼓励组织每月赞助125美元或
更多，根据他们的要求。
...
您可以轻松地在不同的赞助级别之间切换——[升级]或
[降级]——随时。只需访问@squidfunk
[GitHub赞助商简介]并调整您的赞助级别选择。一次
你已经做出了改变，你将立即在新的级别上赞助。

如果您超过当前赞助限额内的项目数量，我们
敬请您将赞助升级到更高级别以保留
MkDocs内部人员访问材料。该更改立即生效，
金额根据您的[计费周期]按比例分配。
